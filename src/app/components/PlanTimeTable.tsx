...
function PlanItemBlock({
  ...
  const title = item.label ?? material?.name ?? category?.name ?? '学習';
...
export function PlanTimeTable({
  ...
  return (
    <div
      ...
      className="bg-white border border-slate-100 rounded-2xl focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-200"
    >
      <div
