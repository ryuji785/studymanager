              ...
              {totalIncomplete > 1 ? (
                <>
                  <Button
                    ...
                    size="icon"
                    aria-label="前の未完了を表示"
                    className="absolute left-3 top-[58%] h-9 w-9 -translate-y-1/2 rounded-full border border-border/70 bg-background shadow-sm"
                  ...
                  <Button
                    ...
                    size="icon"
                    aria-label="次の未完了を表示"
                    className="absolute right-3 top-[58%] h-9 w-9 -translate-y-1/2 rounded-full border border-border/70 bg-background shadow-sm"
